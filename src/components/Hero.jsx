...
export default function Hero() {
  return (
    <section className="text-center py-20 text-black">
      ...
      <div className="mt-6">
        <a type=".pdf" href="/src/assets/Resume.pdf" target="_blank" className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:text-white hover:bg-gradient-to-r from-blue-500 to-violet-600"><FontAwesomeIcon icon={faArrowDown} /> Resume</a>
